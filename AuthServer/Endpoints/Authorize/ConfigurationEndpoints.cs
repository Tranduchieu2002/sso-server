    ...
    app.MapGet(".well-known/openid-configuration", (HttpContext context) =>
        {
            ...
            var filePath = Path.Combine(Directory.GetCurrentDirectory(), "oidc-assets", ".well-known", "openid-configuration.json");
        ...
        {
            var publicJwkFilePath = Path.Combine(Directory.GetCurrentDirectory(), "oidc-assets", ".public", "public-jwk.json");
